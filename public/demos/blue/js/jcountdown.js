(function($) {
	...
	if(timer.length){
		timer.countdown({
			htmlTemplate: "<li><p class='number'> %m </p><p class='text'>Months</p><li><p class='number'> %d </p><p class='text'>Days</p><li><p class='number'> %h </p><p class='text'>Hours</p><li><p class='number'> %i </p><p class='text'>Minutes</p><li><p class='number'> %s </p><p class='text'>Seconds</p>",
